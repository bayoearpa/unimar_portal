...
class DatatablesBuilder
{
    ...
    public function foot($label = null, $source = null, $function = null)
    {
        if($label != null)
        {
            $lb = $label;
    ...
    public function generate($id)
    {
        ...
        if(isset($this->table_footer))
        {
            $this->CI->table->set_footer($this->table_footer);
        }
