            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?></td>
                  <td><?php echo $baak->getnama($c->nim) ?></td>
                  ...
                  <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/kliring_uas/'.$c->id_kuas;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_uas_baak')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/ekliring_uas/'.$c->id_kuas; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
