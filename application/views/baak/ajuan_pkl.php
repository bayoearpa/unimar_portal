                  ...
                  <!-- mahatar -->
                   ...
                   if ($m > "0" && $n > "0"){
                    ...
                    <?php } ?>
                     ...
                     <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/kliring_pkl/'.$c->id_pkl;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_pkl_baak')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/ekliring_pkl/'.$c->id_pkl; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
