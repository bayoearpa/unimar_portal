                  ...
                  <!-- mahatar -->
                   ...
                   if ($m > "0" && $n > "0"){
                    ...
                    <td>
                     ...
                     <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/kliring_prada/'.$c->id_kp;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_prada_baak')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/ekliring_prada/'.$c->id_kp; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
