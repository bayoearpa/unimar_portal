      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Form Edit Kliring PKL</h3>
          </div>
          <div class="box-body">
            ...
            <?php } ?>
              ...
              <form action="<?php echo base_url() ?>baak/ekliringp_pkl" name="form1" id="form1" method="post">
                <input type="hidden" name="id_pkl_baak" id="id_pkl_baak" value="<?php echo $c->id_pkl_baak; ?>">
