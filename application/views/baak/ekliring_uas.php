      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ?>
              <form action="<?php echo base_url() ?>baak/ekliringuasp" name="form1" id="form1" method="post">
                <input type="hidden" name="id_kuas" id="id_kuas" value="<?php echo $c->id_kuas; ?>">   
                <input type="hidden" name="id_uas_baak" id="id_uas_baak" value="<?php echo $c->id_uas_baak; ?>">              
                <div class="form-group">
                  <label>Keterangan (Telah melakukan daftar ulang?) :</label>
                ...
                <a href="<?php echo base_url() ?>baak/ajuan_kuas"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
              <?php } ?>
          </div>
          <!-- /.box-body -->
