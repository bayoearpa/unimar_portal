        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
                  ...
                  <tr>
                    ...
                    <?php 
                      foreach ($list_makul_temp as $keyz) { ?>
                        ...
                        <td><?php 
                          echo $baak->countkuotakelas($keyz->kd_makul);
                         ?></td>
                        </tr>
                      <?php
                      # code...
              ...
              <form action="<?php echo base_url() ?>baak/kliringsmtap" name="form1" id="form1" method="post">
                ...
                <a href="<?php echo base_url() ?>baak/ajuan_smta"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
              <?php } ?>
          </div>
          <!-- /.box-body -->
