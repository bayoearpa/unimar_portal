        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            echo $this->session->flashdata('error');
              ?>
              <form action="<?php echo base_url() ?>baak/search_smta_nim_cari" name="form1" id="form1" method="post">
                ...
                <a href="<?php echo base_url() ?>baak/search_uas_nim"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
          </div>
          <!-- /.box-body -->
        </div>
