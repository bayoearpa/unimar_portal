          ...
          <div class="box-body">
            ...
            foreach($ku as $k){ 
              ...
              <table>
                ...
                <tr>
                   <td colspan="3">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/kliring_smta/'.$k->id_smta;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $where = array(
                    'id_smta' => $k->id_smta      
                    );
                    $m=$this->m_portal->get_data($where,'tbl_kliring_smta_baak')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'baak/ekliring_smta/'.$k->id_smta; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
                </tr>
              </table>
