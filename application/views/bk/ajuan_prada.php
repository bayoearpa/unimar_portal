            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ?></td>
                  <td><?php echo $bk->getnama($c->nim) ?></td>
                  ...
                  <!-- mahatar -->
                   ...
                   if ($m > "0" && $n > "0"){
                    ...
                    <td>
                     ...
                     <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'bk/kliring_prada/'.$c->id_kp;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_prada_bk')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'bk/ekliring_prada/'.$c->id_kp; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
