        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <?php } ?>
              ...
              <form action="<?php echo base_url() ?>bk/ekliringp_pkl" name="form1" id="form1" method="post">
               <input type="hidden" name="id_pkl_bk" id="id_pkl_bk" value="<?php echo $c->id_pkl_bk; ?>">
