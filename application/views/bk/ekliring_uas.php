      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Form Edit Kliring UAS</h3>
          </div>
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ?>
              <form action="<?php echo base_url() ?>bk/ekliringuasp" name="form1" id="form1" method="post">
                <input type="hidden" name="id_kuas" id="id_kuas" value="<?php echo $c->id_kuas; ?>">   
                <input type="hidden" name="id_uas_bk" id="id_uas_bk" value="<?php echo $c->id_uas_bk; ?>">              
                <div class="form-group">
                  <label>Keterangan (Sudah lunas biaya SPP dan Daftar ulang?)  :</label>
                ...
                <a href="<?php echo base_url() ?>bk/ajuan_kuas2022"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
              <?php } ?>
          </div>
          <!-- /.box-body -->
