  ...
  <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>cek_pkl">
    <div class="form-group">
      <a href="<?php echo base_url() ?>ajuan_pkl"><button type="button" class="btn bg-orange btn-flat margin">Ajukan PKL</button></a>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <ol>
          <li>Lakukan pengejuan Prada dengan klik tombol "Ajukan PKL"</li>
          ...
          <li>Hubungi pihak terkait agar kliring segera di <b>ACC</b>, untuk nomor yang dapat dihibungi
              ...
              <ul>>BAAK 085741552229 (Pak Wiji)</ul>
