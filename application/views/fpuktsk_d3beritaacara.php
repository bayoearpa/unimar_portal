...
<body>
<!-- header -->
<img src="<?php echo base_url() ?>assets/1/images/beritacarad3.jpg" alt="">
...
<p>Telah melaksanakan Pengujian Karya Tulis yang diajukan oleh Taruna</p>
<table width="100%">
	<tr>
		<td width="20%">Nama</td>
		<td width="2%">:</td>
...
<table width="100%">
	<tr>
		<td width="45%"><center>Tanda Tangan Taruna Teruji</center> </td>
