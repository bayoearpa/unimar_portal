  ...
  <header class="main-header">
   ...
   <div class="box box-default">
            ...
            <div class="box-header">
              <h3 class="box-title">Pengajuan Kliring, Proposal dan Skripsi</h3>
            </div>       
<div class="box-body">
  <?php 
    ...
    ?>
  <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>pencarianpengajuan">
