          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="tab_1">
               ...
               <!-- chart jajal -->
               <!-- BAR CHART -->
                <h1>Rekap per Dosen : <?php echo $nama_dosen; ?></h1>
                <div class="chart">
              ...
              <div class="tab-pane" id="tab_2">
               ...
               <?php foreach($select_dosen as $k){ ?>
                <tr>
                  ...
                  <td><a href="#" target="_blank"><button type="button" class="btn btn-block btn-primary btn-sm"><i class="fa fa-fw fa-eye"></i>Lihat Statistik</button></a></td>
