          ...
          <div class="box-body">
            ...
            echo $this->session->flashdata('error');
              ...
              <form action="<?php echo base_url() ?>hrd/input_kardosp" name="form1" id="form1" method="post">
                ...
                <div class="form-group">
                  <label>Alamat</label>
                  <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukkan alamat rumah"></textarea>
                </div>
                <div class="form-group">
                  <label>Agama</label>
               ...
               <div class="form-group">
                ...
                <label for="exampleInputEmail1">SK dosen Tetap</label>
                  <input class="form-control" type="text" name="sk_dosen" id="sk_dosen">
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">TMT dosen Tetap</label>
                  <input class="form-control" type="text" name="dosen_tmt" id="dosen_tmt">
                </div>
                <div class="form-group">
                  <label>Status</label>
                  <select class="form-control" name="agama" id="agama">
