      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Update data Kuesioner Dosen ke Lembaga</h3>
          </div>
          <div class="box-body">
            <?php 
            ...
            echo $this->session->flashdata('error');
              ?>
              <form action="<?php echo base_url() ?>lpm/kues_dsnlmdk_run_update" name="form1" id="form1" method="post">
                ...
                <label for="exampleInputEmail1">Pilih Prodi</label>
                   <select class="form-control" name="prodi" id="prodi">
                    ...
                    <option value="63317">D4 MPLM</option>
                ...
                <a href="<?php echo base_url() ?>lpm/"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
          </div>
          <!-- /.box-body -->
        </div>
