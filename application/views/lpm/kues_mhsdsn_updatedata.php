      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Update data Kuesioner mahasiswa ke dosen</h3>
          </div>
          <div class="box-body">
            <?php 
            ...
            echo $this->session->flashdata('error');
              ?>
              <form action="<?php echo base_url() ?>lpm/kues_mhsdsn_prosesupdate" name="form1" id="form1" method="post">
