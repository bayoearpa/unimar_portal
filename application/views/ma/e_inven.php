        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach ($rekap as $r) {
              ...
              <form action="<?php echo base_url() ?>aset/pe_inventaris" name="form1" id="form1" method="post">
               ...
               <!--   <select id="gedung" name="gedung" class="form-control">
                ...
                <div class="form-group">
                  <input type="hidden" name="kd_inventaris" value="<?php echo $r->kd_inventaris; ?>">
                <label for="exampleInputEmail1">Merk:</label>
                  <input class="form-control" type="text" name="merk" id="merk" value="<?php echo $r->merk; ?>">
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">Tahun Beli:</label>
                  <input class="form-control" type="text" name="tahun_beli" id="tahun_beli" value="<?php echo $r->tahun_beli; ?>">
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">Harga Beli:</label>
                  <input class="form-control" type="text" name="harga_beli" id="harga_beli" value="<?php echo $r->harga_beli; ?>">
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">Qty:</label>
                  <input class="form-control" type="text" name="qty" id="qty" value="<?php echo $r->qty; ?>">
                </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="keterangan" id="keterangan" rows="3" placeholder="Masukkan Keterangan"><?php echo $r->keterangan; ?></textarea>
                </div>
