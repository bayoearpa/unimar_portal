            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url().'aset/logout'; ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Aset Tetap</span>
          ...
          <ul class="treeview-menu">
                <li class="treeview">
                  <a href="#"><i class="fa fa-circle-o"></i> Tanah
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                ...
                <li>
                  <a href="<?php echo base_url() ?>aset/gedung"><i class="fa fa-circle-o"></i> Gedung
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                 ...
                 <li>
                  <a href="<?php echo base_url() ?>aset/ruang"><i class="fa fa-circle-o"></i> Ruang
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                ...
                <li>
                  <a href="<?php echo base_url() ?>aset/barang"><i class="fa fa-circle-o"></i> Barang
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                ...
                <li>
                  <a href="<?php echo base_url() ?>aset/inventaris"><i class="fa fa-circle-o"></i> Inventaris
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
...
<!-- ////// -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Aset Tidak Tetap</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Cetak</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
                                <li>
                  <a href="<?php echo base_url() ?>aset/cetak_qr_ruang"><i class="fa fa-circle-o"></i> QRcode Per Ruang
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
         ...
         <li><a href="<?php echo base_url() ?>aset/scan"><i class="fa fa-barcode"></i> <span>Scan Barcode</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Selamat Datang
        <small>Di Sistem Manajamen Aset Yasbinmar 2020</small>
      </h1>
