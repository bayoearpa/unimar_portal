...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url() ?>assets/1/images/amni-png.png"/>
...
<div class="login-box">
  ...
  <img src="<?php echo base_url() ?>assets/1/images/amni-png.png" width="20%">
    <a href="<?php echo base_url() ?>administrasi"><b>Admin</b>Aset</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in untuk mengakses sistem</p>

    <form action="<?php echo base_url().'aset/login' ?>" method="post">
