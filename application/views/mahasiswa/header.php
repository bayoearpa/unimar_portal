...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>M</b>TR</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Portal Mahatar</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Program Studi :<?php echo $this->session->userdata('nprodi'); ?> </small>
                </p>
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if ($this->session->userdata('prodi') == "92403" || $this->session->userdata('prodi') == "92402" ) {
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url() ?>mahasiswa/laponboard/<?php echo $this->session->userdata('user')?>"><i class="fa fa-circle-o"></i>Laporan Bulanan</a></li>
