            ...
            <div class="box-body">
              ...
              # code... ?>
                <?php  foreach ($mhs_detail as $c) { ?>
                  ...
                  <a href="<?php echo base_url() ?>down_format_laporan_bulanan_onboard?>" target="__blank"><button type="button" class="btn btn-primary">Download Panduan Pengisian Ukuran Pakaian</button></a>
