        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Kliring PKL</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <!-- mahatar -->
                   ...
                   if ($m > "0" && $n > "0"){
                    ...
                    <?php } ?>
                     ...
                     <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'mahatar/kliring_pkl/'.$c->id_pkl;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_pkl_mahatar')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'mahatar/ekliring_pkl/'.$c->id_pkl; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
