        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <?php } ?>
              ...
              <form action="<?php echo base_url() ?>mahatar/ekliringp_prada" name="form1" id="form1" method="post">
                <input type="hidden" name="id_kp_m" id="id_kp_m" value="<?php echo $c->id_kp_m; ?>">
