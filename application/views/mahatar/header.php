            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url().'mahatar/logout'; ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>mahatar/ajuan"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>mahatar/ajuan_kuas2022"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <li><a href="<?php echo base_url() ?>mahatar/search_uas_nim"><i class="fa fa-circle-o"></i> Kliring by NIM</a></li>
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>mahatar/ajuan_prada"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
                 <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>mahatar/ajuan_pkl"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
              </ul>
