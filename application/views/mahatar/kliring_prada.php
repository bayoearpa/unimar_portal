        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ...
              <hr>
              <form action="<?php echo base_url() ?>mahatar/kliringp_prada" name="form1" id="form1" method="post">
                ...
                <label for="exampleInputEmail1">Pemeriksaan kerapian, penampilan beserta kelengkapan selama mengikuti pendidikan di Kampus :</label>
                  <div class="radio">
                    <label>
                      <input type="radio" name="kerapian" id="kerapian" value="1">
                      Rapi
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="kerapian" id="kerapian" value="2">
                      Tidak Rapi
                    </label>
                  </div>
                </div>
                ...
                <a href="<?php echo base_url() ?>mahatar/ajuan_prada"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
              <?php } ?>
          </div>
          <!-- /.box-body -->
