        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ...
              <hr>
              <form action="<?php echo base_url() ?>mahatar/kliringuasp" name="form1" id="form1" method="post">
                ...
                <a href="<?php echo base_url() ?>mahatar/ajuan_kuas"><button type="button" class="btn btn-success pull-left"><i class="fa fa-chevron-left"></i>Kembali</button></a>
                </form>
              <?php } ?>
          </div>
          <!-- /.box-body -->
