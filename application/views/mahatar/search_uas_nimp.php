            ...
            foreach($ku as $k){ 
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><label for="exampleInputEmail1">:</label></td>
                  <td><label for="exampleInputEmail1"><?php echo $k->kelas; ?></label></td>
                </tr>
                <tr>
                  <td><label for="exampleInputEmail1">Semester</label></td>
                  <td><label for="exampleInputEmail1">:</label></td>
                  <td><label for="exampleInputEmail1"><?php echo $k->smt_now; ?></label></td>
                </tr>
                <tr>
                   <td colspan="3">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'mahatar/kliring_uas/'.$k->id_kuas;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $where = array(
                    'id_kuas' => $k->id_kuas      
                    );
                    ...
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'mahatar/ekliring_uas/'.$k->id_kuas; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
                </tr>
              </table>
