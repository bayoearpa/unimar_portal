        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="editForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="editstatonboard">Status ujian TRB:</label>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="editstattrb" name="estattrb" value="sudah">
                            <label class="form-check-label" for="editstattrb">Iya</label>
                        </div>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" id="editstattrb" name="estattrb" value="belum">
                            <label class="form-check-label" for="editstattrb">Tidak</label>
                        </div>
                    </div>
                    <div class="form-group">
                  ...
                  <!--   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="ediufsignoff">Upload File SKL TRB</label>
                        <input type="file" class="form-control" id="edituftrb" name="euftrb">
                        <input type="hidden" id="edituftrb_existing" name="euftrb_existing" value="<?php echo $i->upload_file_trb; ?>">
                    </div>
