            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $ppk->getProdi($c->prodi) ?></td>
                  <td>
                    <?php
                    if ($c->jenjang == "1") {
                        # code...
                  ...
                  <!-- mahatar -->
                   ...
                   if ($m > "0" && $n > "0"){
                    ...
                    <td>
                     ...
                     <td>
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'wdosen/kliring_prada/'.$c->id_kp;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $m=$this->m_portal->get_data($where,'tbl_kliring_prada_prodi')->row();
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'wdosen/ekliring_prada/'.$c->id_kp; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
