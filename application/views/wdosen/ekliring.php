      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ?>
              <form action="<?php echo base_url() ?>wdosen/ekliringp" name="form1" id="form1" method="post">
                <input type="hidden" name="id_uks" id="id_uks" value="<?php echo $c->id_uks; ?>">
                <input type="hidden" name="nim" id="nim" value="<?php echo $c->nim; ?>">
                <input type="hidden" name="id_uks_wd" id="id_uks_wd" value="<?php echo $c->id_uks_wd; ?>">
                ...
                <label for="exampleInputEmail1">Pemeriksaan kerapian, penampilan beserta kelengkapan selama mengikuti pendidikan di Kampus :</label>
                  <div class="radio">
                    <label>
                      <input type="radio" name="pktsk" id="pktsk" value="1" <?php echo ($c->pktsk == '1') ? 'checked' : ''; ?>>
                      Rapi
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="pktsk" id="pktsk" value="2" <?php echo ($c->pktsk == '2') ? 'checked' : ''; ?>>
                      Tidak Rapi
                    </label>
                  </div>
                </div>
