        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <?php } ?>
              ...
              <?php             
              foreach($catar as $c){  ?>
              <form action="<?php echo base_url() ?>wdosen/ekliringp_pkl" name="form1" id="form1" method="post">
                <input type="hidden" name="id_pkl_prodi" id="id_pkl_prodi" value="<?php echo $c->id_pkl_prodi; ?>">
