      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            foreach($catar as $c){ 
              ?>
              <form action="<?php echo base_url() ?>wdosen/ekliringuasp" name="form1" id="form1" method="post">
                <input type="hidden" name="id_kuas" id="id_kuas" value="<?php echo $c->id_kuas; ?>">   
                <input type="hidden" name="id_uas_p" id="id_uas_p" value="<?php echo $c->id_uas_p; ?>">              
