            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url().'wdosen/logout'; ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>wdosen/ajuan"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
                <li class="treeview">
                  <a href="#"><i class="fa fa-circle-o"></i> UAS
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>wdosen/ajuan_kuas"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>wdosen/ajuan_prada"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>wdosen/ajuan_pkl"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <!-- <li><a href="<?php //echo base_url() ?>ppk/ajuan_prada"><i class="fa fa-circle-o"></i> Ajuan Prada</a></li> -->
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
                 <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() ?>wdosen/ajuan_tpkl"><i class="fa fa-circle-o"></i> Ajuan</a></li>
                    <!-- <li><a href="<?php //echo base_url() ?>ppk/ajuan_prada"><i class="fa fa-circle-o"></i> Ajuan Prada</a></li> -->
                    <!-- <li><a href="#"><i class="fa fa-circle-o"></i> Selesai</a></li> -->
                  </ul>
                </li>
