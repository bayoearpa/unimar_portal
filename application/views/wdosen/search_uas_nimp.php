          ...
          <div class="box-body">
            ...
            foreach($ku as $k){ 
              ...
              <table>
                ...
                <tr>
                   <td colspan="3">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'wdosen/kliring_uas/'.$k->id_kuas;?>"><span class="glyphicon glyphicon-pencil"></span> Kliring</a>
                    <?php
                    $where = array(
                    'id_kuas' => $k->id_kuas      
                    );
                    ...
                    if ($m > "0"){
                     ?>
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url().'wdosen/ekliring_uas/'.$k->id_kuas; ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                   <?php } ?>
                  </td>
                </tr>
              </table>
